...
export class LegacySocketConnection {
    ...
    ): Promise<LegacySocketConnection> {
        const connection = new LegacySocketConnection(connectedSocket);
    ...
    public static async CreateConnection(
        ...
        const path = await StartLegacySocketConnection();
