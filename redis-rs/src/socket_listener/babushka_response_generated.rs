...
impl<'a> Response<'a> {
  ...
  pub fn callback_idx(&self) -> u32 {
    ...
    unsafe { self._tab.get::<u32>(Response::VT_CALLBACK_IDX, Some(0)).unwrap()}
  }
  #[inline]
  ...
  pub fn response(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Response::VT_RESPONSE, None)}
  }
}
...
impl<'a: 'b, 'b> ResponseBuilder<'a, 'b> {
  ...
  pub fn add_callback_idx(&mut self, callback_idx: u32) {
    self.fbb_.push_slot::<u32>(Response::VT_CALLBACK_IDX, callback_idx, 0);
  }
  #[inline]
